"""
Django settings for ReadersStation project.
...
# Use the database-backed sessions
SESSION_ENGINE = 'django.contrib.sessions.backends.db'
SESSION_COOKIE_AGE = 1209600  # Set the session cookie age to two weeks (in seconds)
...
ROOT_URLCONF = 'readersstation.urls'
...
#
WSGI_APPLICATION = 'readersstation.wsgi.application'
